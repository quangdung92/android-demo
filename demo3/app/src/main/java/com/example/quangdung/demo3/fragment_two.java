...
//        Button btnGetText = (Button) getActivity().findViewById(R.id.btn_frag_one);
//        btnGetText.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                TextView fragoneText = (TextView) getActivity().findViewById(R.id.frag_one_text);
//                Toast.makeText(getActivity(), fragoneText.getText(),Toast.LENGTH_LONG);
//            }
//        });
    }
